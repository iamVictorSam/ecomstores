...
//
//     final retrieveOrders = retrieveOrdersFromJson(jsonString);

import 'dart:convert';

List<RetrieveOrders> retrieveOrdersFromJson(String str) =>
    List<RetrieveOrders>.from(
        json.decode(str).map((x) => RetrieveOrders.fromJson(x)));

String retrieveOrdersToJson(List<RetrieveOrders> data) =>
